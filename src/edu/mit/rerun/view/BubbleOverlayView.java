...
public class BubbleOverlayView extends FrameLayout {
    
    private LinearLayout layout;
    private TextView title;
    private TextView snippet;
    
    public BubbleOverlayView(Context context, int balloonBottomOffset) {
        super(context);
    ...
    //sets the text contained in the balloon
